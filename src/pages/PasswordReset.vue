      ...
      <div class="container">
        <div class="columns is-vcentered">
          <div class="column hero-caption">
            <h1
              class="title is-size-2 has-text-weight-light"
              id="title"
            >Woops, I've misplaced my password...</h1>
            <h2
              class="subtitle is-5 has-text-weight-light"
            >Enter your email and we'll find one for you</h2>
            <br />
            <div class="field">
            ...
            <p class="buttons">
              <router-link to="/apikey" class="button is-link is-solid">
                <span class="icon is-small">
                  <i class="fas fa-lock"></i>
                </span>
                <span class="has-text-weight-bold">Reset password</span>
              </router-link>
            </p>
          </div>
